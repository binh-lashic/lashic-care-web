							...
							<table>
								<tbody>
									...
									<tr>
										<th>郵便番号</th>
										<td>
											<input type="text" class="input_text input_short p-postal-code" maxlength="7" name="zip_code" value="<?php echo $data['zip_code']; ?>">
									...
									<tr>
										...
										<td>
											...
											<label for="no" class="checkbox">受け取らない</label>
										</td>
									</tr>
									<tr>
