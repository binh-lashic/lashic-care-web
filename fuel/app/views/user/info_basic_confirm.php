				...
				<div class="form_set_container">
						<div class="userDate_photo">
							<div class="aside_photo">
								<div class="aside_photoInner"><img src=" <?php if(isset($data['profile_image'])) { ?>/images/user/<?php echo $data['profile_image']; ?><?php } else if(isset($client['profile_image'])) { ?><?php echo $client['profile_image']; ?><?php } else { ?>/images/common/img_no-image.jpg<?php } ?>" width="179" height="179" alt=""/></div>
							</div>
						</div>
