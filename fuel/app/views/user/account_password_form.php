						...
						<table>
								<tbody>
									<tr>
										...
										<td><input type="password" name="password" class="input_text input_short" minlength="8" maxlength="16"> <span class="small text_red">※半角英数 8桁以上</span>
<?php
...
?>	
									...
									<tr>
										...
										<td><input type="password" name="new_password" class="input_text input_short" minlength="8" maxlength="16"> <span class="small text_red">※半角英数 8桁以上で、できるだけ複雑な文字の組み合わせでご入力ください。　例）W4eHvmCE</span>
<?php
...
?>										</td>
									...
									<tr>
										...
										<td><input type="password" name="new_password_confirm" class="input_text input_short" minlength="8" maxlength="16"> <span class="small text_red">※半角英数 8桁以上</span>
<?php
