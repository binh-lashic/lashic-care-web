...
”あんしん”を共有する"/></a></div>
				...
				<div class="floatR"><a href="#moreInfo" class="fancybox link_next">もっと「CareEye」を知る</a></div>
	...
	個々の高齢者にあった介護サービスや福祉用具の利用などを紹介し、ご家族の負担を軽減します。</p>
					...
					<div class="regist_waku clearfix">
						...
						<div class="floatR regist_waku_right">
							<h3 class="regist_h3 mgb20">Care Eye モニター画面</h3>
							<ul>
								<li class="clearfix">
...
「CareEye」からの通知やレポートにより、事前準備をある程度想定しておくことで、ゆとりを持って個々の状態や環境にふさわしい選択が可能とります。</p>
					<!-- /text -->
						...
						<a href="javascript:$.fancybox.close();" class="btn_lightGray radius20 regist_btn_close mgt30">×閉じる</a>
				</div>
			</div>
			<!-- /デザインあとではめ込み -->
...
?>
									...
									<tr>
										...
										<td><input type="password" name="password" class="input_text input_short" minlength="8" placeholder="パスワード入力">
										<br>
...
?>
									...
									<tr>
										...
										<td><input type="password" name="password_confirm" class="input_text input_short" minlength="8" placeholder="パスワード入力">
