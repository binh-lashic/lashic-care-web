...
<div class="row">
	<div class="col-sm-12">
		...
		<form action="/admin/account" class="form-horizontal" method="post">
		<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="email" class="form-control" name="email_confirmation" id="form_email_confirmation" />
					</div>
				</div>	
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input class="btn btn-primary" name="update_account" value="登録" type="submit" id="form_update_account" />
					</div>
				</div>
		</form>
		</div>
