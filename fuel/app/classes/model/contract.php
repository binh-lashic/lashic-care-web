...
class Model_Contract extends Orm\Model{
    ...
    public function getSearch($params) {
        $sql = "SELECT c.id,c.price,c.shipping,c.start_date,c.renew_date,u.last_name,u.first_name,p.title,p.type,count(shipping_date) AS shipping_count,count(s.id) AS sensor_count ".
               " FROM contracts c ".
