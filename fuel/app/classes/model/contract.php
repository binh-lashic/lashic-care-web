...
class Model_Contract extends Orm\Model{
    ...
    public function getSearch($params) {
        $sql = "SELECT c.id,c.price,c.shipping,c.start_date,c.renew_date,c.end_date,c.status,
                u.last_name,u.first_name,p.title,p.type,st.store_name,ag.agent_name,
                count(s.shipping_date) AS shipping_count,count(s.id) AS sensor_count ".
               " FROM contracts c ".
        ...
        $sql .= " GROUP BY c.id,c.price,c.shipping,c.start_date,c.renew_date,c.end_date,c.status,u.last_name,
                u.first_name,p.title,p.type,st.store_name,ag.agent_name,u.last_name,u.first_name ".
                " ORDER BY c.id DESC;";
    ...
    public function getClients($params) {
        $sql = "SELECT c.id,c.price,c.shipping,c.start_date,c.renew_date,c.client_user_id,u.last_name,
                u.first_name,u.last_kana,u.first_kana,p.title,c.affiliate,p.type,st.store_name,ag.agent_name,
                count(s.shipping_date) AS shipping_count,count(s.id) AS sensor_count ".
               " FROM contracts c ".
        ...
        $sql .= " GROUP BY c.id,c.price,c.shipping,c.start_date,c.renew_date,c.client_user_id,u.last_name,
                u.first_name,u.last_kana,u.first_kana,p.title,p.type,st.store_name,ag.agent_name ".
                " ORDER BY c.id DESC;";
